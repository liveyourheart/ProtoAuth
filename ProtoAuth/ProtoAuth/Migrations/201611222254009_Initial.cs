namespace ProtoAuth.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        UserName = c.String(),
                        UnhashedPassword = c.String(),
                        TrendsRoleId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        EnterpriseNumber = c.Int(nullable: false),
                        Name = c.String(),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        ServiceOrderNumber = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Customers", "EnterpriseId", "dbo.Enterprises");
            ...
            DropIndex("dbo.Customers", new[] { "EnterpriseId" });
            DropTable("dbo.AspNetUserLogins");
            DropTable("dbo.AspNetUserClaims");
            DropTable("dbo.AspNetUsers");
            DropTable("dbo.TrendsRoles");
